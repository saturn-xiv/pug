...
diesel print-schema --database-url "postgres://postgres:@localhost:5432/pug" -o -- locales > src/i18n/locales/postgresql/schema.rs
...
diesel print-schema --database-url "postgres://postgres:@localhost:5432/pug" -o -- cards links friend_links leave_words votes > src/nut/site/postgresql/schema.rs
...
diesel print-schema --database-url "mysql://root:@localhost:3306/pug" -o -- locales > src/i18n/locales/mysql/schema.rs
...
diesel print-schema --database-url "mysql://root:@localhost:3306/pug" -o -- cards links friend_links leave_words votes > src/nut/site/mysql/schema.rs
...
diesel print-schema --database-url "tmp/db" -o -- locales > src/i18n/locales/sqlite/schema.rs
diesel print-schema --database-url "tmp/db" -o -- users logs policies attachments notifications > src/nut/auth/sqlite/schema.rs
diesel print-schema --database-url "tmp/db" -o -- cards links friend_links leave_words votes > src/nut/site/sqlite/schema.rs
